...
GameObject_Plane::GameObject_Plane(ID3D11Device* _device, std::wstring textureDir, int planeWidth, int planeDepth, vector3 initPos, vector3 initRot, vector3 initScale, Material _material) : GameObject(_device, "", textureDir, vector3(initPos.x, initPos.y, initPos.z), vector3(initRot.x, initRot.y, initRot.z), vector3(initScale.x, initScale.y, initScale.z), _material) {
